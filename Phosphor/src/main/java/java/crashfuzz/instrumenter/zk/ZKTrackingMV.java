package java.crashfuzz.instrumenter.zk;
...
public class ZKTrackingMV extends TaintAdapter implements Opcodes {
    ...
    public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean isInterface) {
    	if (Configuration.FOR_ZK && isRecord(this.ownerSuperCname,this.ownerInterfaces)
    			&& this.name.equals("deserialize$$PHOSPHORTAGGED")
...
//        		acceptFn(fn);
        ...
        if(Configuration.FOR_ZK && isRecord(this.ownerSuperCname,this.ownerInterfaces)
    			&& this.name.equals("serialize$$PHOSPHORTAGGED")
...
//        		acceptFn(fn);
    ...
    public void visitFieldInsn(int opcode, String owner, String name, String descriptor) {
    	...
    	if(isOutputStream(this.ownerSuperCname,this.ownerInterfaces)
				...
				&& this.owner.equals(owner)//crashfuzz: TODO: find a better way to verify the object is this
				&& descriptor.equals("Ljava/io/OutputStream;")
				&& opcode == Opcodes.PUTFIELD
				&& (!Configuration.FOR_YARN || (Configuration.FOR_YARN && this.name.equals("out")))
//				&& this.name.equals("out") //crashfuzz: this may cause omission and fail tracking zk
...
//				 && this.name.equals("in") //crashfuzz: this may cause omission and fail tracking zk
				&& opcode == Opcodes.PUTFIELD) {
			//[this, in]
			//[this, in, in]
			super.visitInsn(DUP);
	...
	public void visitInsn(int opcode) {
        ...
        if(opcode == ARETURN) {
        	if(this.owner.equals("java/net/Socket") && this.name.equals("getOutputStream"+TaintUtils.METHOD_SUFFIX)) {
        		super.visitInsn(DUP);
        	...
        	if(this.owner.equals("java/net/Socket") && this.name.equals("getInputStream"+TaintUtils.METHOD_SUFFIX)) {
        		super.visitInsn(DUP);
        		super.visitTypeInsn(CHECKCAST, Type.getInternalName(TaintedReferenceWithObjTag.class));
        		super.visitFieldInsn(GETFIELD, Type.getInternalName(TaintedReferenceWithObjTag.class), "val", "Ljava/lang/Object;");
