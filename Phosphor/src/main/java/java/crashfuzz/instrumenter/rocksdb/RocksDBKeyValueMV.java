...
public class RocksDBKeyValueMV extends MethodVisitor implements Opcodes {
    ...
    public void visitInsn(int opcode) {
        ...
        if (opcode == ARETURN) {
            ...
            super.visitMethodInsn(INVOKESTATIC, "java/crashfuzz/instrumenter/rocksdb/RocksDBCV", "helper", "(Ledu/columbia/cs/psl/phosphor/struct/TaintedReferenceWithObjTag;Ljava/lang/String;)Ledu/columbia/cs/psl/phosphor/struct/TaintedReferenceWithObjTag;", false);
        }
