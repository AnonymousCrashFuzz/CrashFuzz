...
public class RocksDBPutMV extends MethodVisitor implements Opcodes {
    ...
    public void visitCode() {
        ...
        super.visitMethodInsn(INVOKESTATIC, "java/crashfuzz/instrumenter/rocksdb/RocksDBCV", "recordHelper", "(JLjava/io/FileOutputStream;Ljava/lang/String;Ledu/columbia/cs/psl/phosphor/struct/LazyByteArrayObjTags;II)V", false);
