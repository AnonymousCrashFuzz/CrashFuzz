...
public class RocksDBWriteMV extends MethodVisitor implements Opcodes {
    ...
    public void visitCode() {
        ...
        super.visitMethodInsn(INVOKESTATIC, "java/crashfuzz/record/instrumentation/RecordTaint", "getTimestamp", "()J", false);
        super.visitMethodInsn(INVOKESTATIC, "java/crashfuzz/record/instrumentation/RecordTaint", "getRecordOutStream", "()Ljava/io/FileOutputStream;", false);
        super.visitInsn(DUP);
        ...
        super.visitMethodInsn(INVOKESTATIC, "java/crashfuzz/instrumenter/rocksdb/RocksDBCV", "recordTaintHelper", "(JLjava/io/FileOutputStream;Ljava/lang/String;Ledu/columbia/cs/psl/phosphor/runtime/Taint;)V", false);
        ...
        mv.visitMethodInsn(INVOKESTATIC, "java/crashfuzz/record/instrumentation/RecordTaint", "getRecordOutStream", "()Ljava/io/FileOutputStream;", false);
        ...
        mv.visitMethodInsn(INVOKESTATIC, "java/crashfuzz/record/instrumentation/RecordTaint", "getTimestamp", "()J", false);
        mv.visitVarInsn(ALOAD, 9);
        mv.visitVarInsn(ALOAD, 6);
        mv.visitVarInsn(ALOAD, 8);
        mv.visitInsn(ICONST_0);
        mv.visitVarInsn(ILOAD, 10);
        mv.visitMethodInsn(INVOKESTATIC, "java/crashfuzz/instrumenter/rocksdb/RocksDBCV", "recordHelper", "(JLjava/io/FileOutputStream;Ljava/lang/String;Ledu/columbia/cs/psl/phosphor/struct/LazyByteArrayObjTags;II)V", false);
        mv.visitLabel(label);
