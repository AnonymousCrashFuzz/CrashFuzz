...
public class RocksDBWriteBatchPutMV extends MethodVisitor implements Opcodes {
    ...
    public void visitCode() {
        ...
        super.visitMethodInsn(INVOKESTATIC, "java/crashfuzz/instrumenter/rocksdb/RocksDBWriteBatchPutMV", "combineBatchTaint", "(Ledu/columbia/cs/psl/phosphor/runtime/Taint;Ledu/columbia/cs/psl/phosphor/struct/LazyByteArrayObjTags;)Ledu/columbia/cs/psl/phosphor/runtime/Taint;", false);
