package java.crashfuzz.instrumenter.yarn;
...
public class YarnInstrument {
    ...
    public static Object getLinkSourceFromMsg(List list) {
        try {
            ...
            System.out.println("!!!crashfuzz get rpc message id from message wrong:"+e);
            e.printStackTrace();
        }
    ...
    public static InetAddress getIPByName(String name) {
        ...
        try {
           address = InetAddress.getByName(name);
            ...
            System.out.println("!!!!!crashfuzz storeYarnRpcClientSideSocket UnknownHostException");
        }
        return address;
     }
    public static String storeYarnRpcClientSideSocket(Class protocol, InetSocketAddress address) {
        ...
        if(YarnProtocols.isYarnProtocol(protocol.getName())) {
            if(address == null) {
                System.out.println("!!!crashfuzz storeYarnRpcClientSideSocket get null address");
            } else if (address.getAddress() == null) {
                System.out.println("!!!crashfuzz storeYarnRpcClientSideSocket cannot resolve the address");
