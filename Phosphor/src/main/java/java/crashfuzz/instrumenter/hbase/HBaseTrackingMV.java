package java.crashfuzz.instrumenter.hbase;
...
//    		lvs.freeTmpLV(sBuilder);
    ...
    public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean isInterface) {
        if(Configuration.USE_FAV && Configuration.FOR_HBASE || Configuration.HBASE_RPC) {
        	if(owner.endsWith("Service$BlockingInterface") && !this.name.equals("callBlockingMethod$$PHOSPHORTAGGED")) {//avoid server side calls
