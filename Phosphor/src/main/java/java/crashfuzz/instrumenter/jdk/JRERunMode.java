package java.crashfuzz.instrumenter.jdk;
...
import java.crashfuzz.triggering.FaultSequence.FaultPos;
...
public class JRERunMode {
    ...
    public static Taint newFAVTaintOrEmpty(String cname, String mname, String desc, String type, String tag, String linkSource, String jretype) {
    	...
    	if(Configuration.USE_FAV) {
        	...
        	if(callStackString.toString().contains("java.crashfuzz") || callStackString.toString().contains("edu.columbia.cs.psl.phosphor")) {
        		return Taint.emptyTaint();
        	}
            // if(Configuration.FAVDEBUG) {
            //     System.out.println("crashfuzz read a byte from:"+linkSource);
            // }
...
//            }
//            if(Configuration.FAVDEBUG) {
//                System.out.println("crashfuzz read "+rst+" bytes from:"+linkSource);
//            }
...
//        }
    ...
    public static void recordOrTriggerCreateDelete(long timestamp, FileOutputStream out, String path, Taint t) {
    ...
    public static void recordByteOrTrigger(long timestamp, FileOutputStream out, String path, byte b, Taint taint, String jretype) {
    	...
    	if(Configuration.USE_FAV) {
        	...
        	try {
                // if(Configuration.FAVDEBUG) {
                //     RecordTaint.printString("crashfuzz: system is going to write a byte to "+path+", taint:"+taint);
                // }
                // if(skipPath(path)) {
                // 	return;
                // }
    ...
    public static void recordBytesOrTrigger(long timestamp, FileOutputStream out, String path, LazyByteArrayObjTags bytes, int off, int len, String jretype) {
    	...
    	if(Configuration.USE_FAV) {
        	...
        	try {
                ...
                // }
                // if(Configuration.FAVDEBUG) {
                //     System.out.println("crashfuzz: goint to record the write to "+path);
                // }
