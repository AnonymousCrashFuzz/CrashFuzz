...
public final class LazyByteArrayObjTags extends LazyArrayObjTags {
    ...
    public void set(int idx, byte val, Taint tag) {
        this.val[idx] = val;
        if(taints == null && tag != null && !tag.isEmpty()) {//crashfuzz
        //commented out
        //this aims to save memory space
        //if(taints == null && tag != null) {//crashfuzz add
            //crashfuzz: original phosphor code would not keep the empty taint value
