...
public class PowerSetTree {
    ...
    * */
    ...
    public static final class SetNode extends Taint {
        ...
        //crashfuzz
        @Override
		public Taint intersectionLabels(Taint _other) {
            if (_other == null) {
                return null;
            }
            ...
            while (!cur.isEmpty() && !other.isEmpty()) {
                if (cur == other) {
                    ...
                    if(cur.key.object.equals(other.key.object)){
            ...
            // Start to create the intersection taint
            SetNode result = cur.isEmpty() ? cur : other;
