...
public class CharacterUtils {
    ...
    //crashfuzz: gy add this method to fix phosphor error
    public static TaintedIntWithObjTag codePointBeforeImpl$$PHOSPHORTAGGED(LazyCharArrayObjTags tags, Taint tagsTaint, int i, Taint t, int i2, Taint t2, TaintedIntWithObjTag ret) {
