...
public class ReflectionHidingMV extends MethodVisitor implements Opcodes {
    ...
    public ReflectionHidingMV(MethodVisitor mv, String className, String name, String desc, boolean isEnum) {
        super(Configuration.ASM_VERSION, mv);
        this.className = className;
        this.methodName = name;
        this.disable = shouldDisable(className, name);
        this.isEnumValueOf = isEnum && name.equals("valueOf$$PHOSPHORTAGGED") && desc.startsWith("(Ljava/lang/String;");
    }
