...
import java.crashfuzz.instrumenter.CoverageMap;
//import java.crashfuzz.instrumenter.CodeCoverageCV;
import java.crashfuzz.instrumenter.mapred.MRAddParamCV;
 import java.crashfuzz.instrumenter.mapred.MRAddRPCCV;
import java.crashfuzz.instrumenter.mapred.MRTrackingCV;
import java.crashfuzz.instrumenter.rocksdb.RocksDBCV;
import java.crashfuzz.taint.FAVTaint;
import javafl.JavaAflInstrument.InstrumentationOptions;
import javafl.JavaAflInstrument.InstrumentingClassVisitor;
...
public class PreMain {
    ...
    public static String ip = "IP";//crashfuzz
    public static String proc = "PROC";//crashfuzz
    ...
    public static void premain(String args, Instrumentation inst) {
        ...
        System.out.println(FAVTaint.getProcessID()
                +" Running with crashfuzz! Use FAV:"+Configuration.USE_FAV
...
//                        System.out.println("************add InstrumentingClassVisitor*************");
                    ...
                    _cv = new MRTrackingCV(_cv, skipFrames);//crashfuzz add
                    _cv = new MRAddRPCCV(_cv, skipFrames);//crashfuzz add
                    _cv = new MRAddParamCV(_cv, skipFrames);//crashfuzz add

//                    _cv = new CodeCoverageCV(_cv, skipFrames);//crashfuzz add
