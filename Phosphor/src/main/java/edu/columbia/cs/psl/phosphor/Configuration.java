...
public class Configuration {
    ...
    public static Set<String> ignoredMethods = new HashSet<>();  //crashfuzz: phosphor use it to manually specify methods to skip intrumentation
    /*
    ...
    public static String FAV_HOME; //crashfuzz, for loading systime
    public static final int PROTO_MSG_ID_TAG = 1024;
    public static boolean STRICT_CHECK = true; //crashfuzz
    public static boolean IS_THIRD_PARTY_PROTO = true;
    public static boolean FOR_YARN = false; //crashfuzz
    public static boolean FOR_HDFS = false; //crashfuzz
    public static boolean FOR_HBASE = false; //crashfuzz
    ...
    public static boolean FOR_MR = false; //crashfuzz
    public static boolean MR_RPC = false;
    public static boolean FOR_ZK = false; //crashfuzz
    public static boolean ZK_CLI = false; //crashfuzz
    public static boolean ASYC_TRACE = false; //crashfuzz
    public static boolean USE_MSGID = false; //crashfuzz
    public static boolean FOR_JAVA = false; //crashfuzz
    public static boolean JDK_MSG = false; //crashfuzz
    public static boolean ZK_API = false;
    public static boolean HDFS_API = false;
    public static boolean JDK_FILE = false; //crashfuzz
    public static boolean USE_FAV = true; //crashfuzz, default not to use record and trigger logic
    public static boolean RECORD_PHASE = true; //crashfuzz
    public static String FAV_RECORD_PATH = null; //crashfuzz
    public static String COV_PATH = null; //crashfuzz
    ...
    public static final Class TAINT_TAG_OBJ_ARRAY_CLASS = (Taint[].class); //crashfuzz
