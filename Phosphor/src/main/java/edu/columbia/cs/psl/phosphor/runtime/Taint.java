...
public abstract class Taint<T> implements Serializable {
	...
	public abstract Taint<T> intersectionLabels(Taint<T> other);
    ...
    /* crashfuzz: Returns a taint that containt common labels of t1 and t2. */
    public static <T> Taint<T> commonTaint(Taint<T> t1, Taint<T> t2){
        if(t1 == null || t2 == null){
            return null;
        }
        ...
        Taint<T> r = t1.intersectionLabels(t2);
        return r;
    }
