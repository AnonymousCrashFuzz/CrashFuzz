...
public class TaintUtils {
    ...
    public static final String FAV_BUFFER_MSGID_FIELD = "FAV_MSG_ID";//crashfuzz
    public static final String FAV_RECORD_TAG = "FAV_SHOULD_RECORD";//crashfuzz
    public static final String FAV_HDFSSTREAM_PATH = "FAV_HDFSSTREAM_PATH";//crashfuzz
    public static final String FAV_FILEDESCRIPTOR_MT = "favGetParentPath";//crashfuzz
    public static final String FAV_GETFILESTREAMPATH_MT = "favGetFileStreamPath";//crashfuzz
    public static final String FAV_GETBUFFERTAINTS_MT = "favGetHBTaints";//crashfuzz
    public static final String FAV_GETBUFFERSHADOW_MT = "favGetHBShadow";//crashfuzz
    public static final String FAV_FILEOUT_NOTRECORD = "favNotRecordToFile";//crashfuzz
    public static final String FAV_RPC_SOCKET = "FAV_DEST_IP";
    public static final String FAV_PATH = "FAV_FILE_PATH";//crashfuzz
    public static final String FAV_TAINT_PATH = "FAV_TAINT_PATH";//crashfuzz
