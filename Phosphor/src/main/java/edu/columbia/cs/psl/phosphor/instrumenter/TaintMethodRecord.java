...
import java.crashfuzz.instrumenter.AppRunMode;
import java.crashfuzz.instrumenter.yarn.YarnRunMode;
import java.crashfuzz.instrumenter.jdk.JRERunMode;
import java.crashfuzz.instrumenter.mapred.MRRunMode;
...
public enum TaintMethodRecord implements MethodRecord {
    ...
    JRE_RECORD_OR_TRIGGER_CREATEDEL(INVOKESTATIC, JRERunMode.class, "recordOrTriggerCreateDelete", Void.TYPE, false, long.class, FileOutputStream.class, String.class, TAINT_TAG_OBJ_CLASS),
